...
import { DialogAction, DialogActionType, DialogState, DialogProps, DialogOptions } from './types'
...
const mergeDialogOptions = (dialog: DialogProps, newDialogOptions: DialogOptions): DialogProps => {
  return {
    ...
    secondaryButtonProps: { ...dialog.secondaryButtonProps, ...newDialogOptions.secondaryButtonProps },
  }
}
