export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:4201'
...
export const GOOGLE_OPTIMIZA_FILTER_ORDER =
  process.env.NEXT_PUBLIC_GOOGLE_OPTIMIZE_FILTER_ORDER || ''

export const ENABLE_DARK_THEME = process.env.NEXT_PUBLIC_ENABLE_DARK_THEME === 'true'
export const ENABLE_COURSE_THUMBNAIL = process.env.NEXT_PUBLIC_ENABLE_COURSE_THUMBNAIL === 'true'
export const ENABLE_DAY_OF_WEEK_THUMBNAIL =
  process.env.NEXT_PUBLIC_ENABLE_DAY_OF_WEEK_THUMBNAIL === 'true'

export const ENABLE_LOGGING = process.env.NEXT_PUBLIC_ENABLE_LOGGING === 'true'

export const ADMIN_ACCESS_TOKEN = process.env.NEXT_PUBLIC_ADMIN_ACCESS_TOKEN || ''
