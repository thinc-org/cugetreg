  ...
  return (
    <Box marginTop={4} marginBottom={4}>
      <Box sx={{ p: 4, maxWidth: '720px', margin: 'auto' }}>
        ...
        <StyledArticleBox>
          <ul>
            <li>
              ...
              ของสำนักงานการทะเบียน ในปัจจุบัน ข้อมูลจากหน้านี้อาจล่าช้าจากข้อมูลภายในระบบ Reg Chula
              ไป 1 วัน ทั้งนี้
              ทีมงานกำลังประสานงานกับสำนักงานการทะเบียนเพื่อเข้าถึงข้อมูลรายวิชาโดยตรง
              เพื่อให้ไม่พบปัญหาดังกล่าว
            </li>
            <li>
              <strong>ข้อมูลตอนเรียนรายวิชา GenEd:</strong> ได้รับข้อมูลจาก Gen อย่าได้ Ed
        ...
        <StyledArticleBody variant="body1" paragraph>
          สามารถแจ้งปัญหาขัดข้องเกี่ยวกับการใช้งานเว็บไซต์ ข้อมูลที่ไม่ถูกต้อง หรือข้อเสนอแนะต่าง ๆ
          ได้ทาง{' '}
          <Link
