...
export const GOOGLE_AUTH_CLIENT_ID = process.env.NEXT_PUBLIC_GOOGLEAUTH_CLIENTID || ''
export const GOOGLE_AUTH_CODEREDIRECTOR = process.env.NEXT_PUBLIC_GOOGLEAUTH_CODEREDIRECTOR || ''
