/*
  ...
  - The `professors` column on the `course_class` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- AlterTable
ALTER TABLE "course_class" DROP COLUMN "professors",
