  ...
  <div class="w-[80%] min-w-[60vw]">
    ...
    <div class="my-5 flex">
      ...
      <div lang="th" class="font-sarabun flex-1 wrap-break-word">
        ...
        ผ่านการทำโปรเจคพัฒนาซอฟต์แวร์เพื่อสังคมจุฬาฯ ผลงานที่ผ่านมาของชมรม
        Thinc. เช่น
        <ul class="list-disc pl-5">
          <li>ระบบจองสนามกีฬา CU Sports Center แอปพลิเคชัน CU Pop Bus</li>
          <li>ระบบลงทะเบียนขึ้นสแตนด์แปรอักษรฝั่งจุฬาฯ</li>
          <li>
            งานฟุตบอลประเพณีจุฬาฯ-ธรรมศาสตร์ ครั้งที่ 74 Companion App ในงาน
          </li>
    ...
    <QuestionAnswer question="ที่มาของโปรเจค">
      ...
      ที่มักจะต้องลงทะเบียนทั้งวิชาบังคับ วิชาเลือก และวิชาศึกษาทั่วไป (GenEd)
      ในแต่ละเทอม แต่จำเป็นต้องหาข้อมูลจากหลาย ๆ แหล่งที่แตกต่างกัน
    ...
    <QuestionAnswer question="CU Get Reg นำข้อมูลมาจากไหน?">
      <ul class="list-disc">
        ...
        <li>
          ในปัจจุบัน ข้อมูลจากหน้านี้อาจล่าช้าจากข้อมูลภายในระบบ Reg Chula ไป 1
          วัน ทั้งนี้
    ...
    <QuestionAnswer question="ติดต่อทีมงาน">
      ...
      <ul class="list-normal mt-2 space-y-3 fill-blue-700">
        ...
        <li class="flex items-center">
          ...
          <a class="link" href="https://www.facebook.com/ThailandIncubator"
            >Facebook: Thinc.</a
          >
        </li>
        <li class="flex items-center">
          <GitHubMark class="m-2 h-[2em] w-[2em]" />
          <a class="link" href="https://github.com/thinc-org">GitHub: Thinc.</a>
        </li>
        <li class="flex items-center">
          <Instagram class="m-2 h-[2em] w-[2em]" />
