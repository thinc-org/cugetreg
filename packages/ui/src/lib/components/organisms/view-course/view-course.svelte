...
<div class="border border-neutral-200 rounded-lg p-5 w-[50vw] bg-surface">
    <div class="">
        <div class="flex justify-between mb-2">
            ...
            <IconButton class="outline-none! ring-0! bg-transparent hover:cursor-pointer" onclick={onExit}>
                <X />
            </IconButton>
        </div>
    ...
    <div class="flex my-3 justify-between">
        ...
        <div class="flex justify-center items-center">
            <Chip class={cn("h-fit",
                full ? "bg-on-error-container text-on-error" :
