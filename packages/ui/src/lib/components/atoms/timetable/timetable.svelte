...
<div
	class={cn('inline-grid border-t border-l border-neutral-200', className)}
	style="
        grid-template-columns: repeat({periodPerDay + 1}, minmax(60px, 80px));
...
>
	...
	<div
		...
		style="
            ...
            grid-template-columns: repeat({periodPerDay}, minmax(60px, 80px));
        "
	>
