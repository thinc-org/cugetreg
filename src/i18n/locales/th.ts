...
export const regWarNotice = {
  reason: 'สาเหตุ',
  notice:
    'ขณะนี้กำลังอยู่ในช่วงสงครามการแย่งชิงที่นั่ง ข้อมูลที่นั่งจึงมีความเปลี่ยนแปลงตลอดเวลา ขอให้ล็อกอินและดูข้อมูลจากเว็บไซต์ สนท. เป็นหลัก',
  more: 'เพิ่มเติม',
  morenotice:
    'ถึงแม้ว่าเว็บไซต์นี้จะตั้งอยู่ที่ สนท. แต่ข้อมูลที่อยู่ในเว็บไซต์นี้นั้นถูกนำเข้ามาจากเว็บไซต์ของ สนท. อีกที ไม่ได้เชื่อมต่อกับระบบของ สนท. โดยตรง ทำให้ข้อมูลในเว็บไซต์นี้มีความช้ากว่าข้อมูลจาก สนท. ประมาณ 4 ชั่วโมงถึง 1 วัน ในช่วงสงครามการแย่งชิงที่นั่งนี้ ข้อมูลที่นั่งจะเปลี่ยนแปลงอย่างรวดเร็ว จึงขอให้ตรวจสอบจากเว็บไซต์ของ สนท. เป็นหลัก ทั้งนี้ทางทีมงานกำลังอยู่ในระหว่างการเจรจากับ สนท. เพื่อเชื่อมต่อระบบเข้าโดยตรงต่อไป',
}
